...
func Display(localPlayer *co.Participant, room *co.Room, controlFromUI chan<- string, displayControl <-chan bool) {
	...
	barGraph.AddBar(co.CommandVote1, 0, tcell.ColorWhite)
	barGraph.AddBar(co.CommandVote2, 0, tcell.ColorSaddleBrown)
	barGraph.AddBar(co.CommandVote3, 0, tcell.ColorDodgerBlue)
	barGraph.AddBar(co.CommandVote5, 0, tcell.ColorLimeGreen)
	barGraph.AddBar(co.CommandVote8, 0, tcell.ColorDarkTurquoise)
	barGraph.AddBar("13", 0, tcell.ColorGold)
	barGraph.AddBar("21", 0, tcell.ColorFuchsia)
	barGraph.AddBar("?", 0, tcell.ColorDeepSkyBlue)
