...
func Display(localPlayer *co.Participant, room *co.Room, controlFromUI chan<- string, displayControl <-chan bool) {
	...
	barGraph.AddBar(co.CommandVote2, 0, tcell.ColorMaroon)
	barGraph.AddBar(co.CommandVote3, 0, tcell.ColorRed)
	barGraph.AddBar(co.CommandVote5, 0, tcell.ColorGreen)
	barGraph.AddBar(co.CommandVote8, 0, tcell.ColorBlue)
	barGraph.AddBar("13", 0, tcell.ColorYellow)
	barGraph.AddBar("21", 0, tcell.ColorDarkCyan)
	barGraph.AddBar("?", 0, tcell.ColorDarkMagenta)
